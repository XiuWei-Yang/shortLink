...
public enum ResponseCode {
    ...
    ID_GENERATOR_INVOKE_ERROR(HttpResponseStatus.INTERNAL_SERVER_ERROR, 20007, "ID生成器调用错误"),
    ID_GENERATOR_INVOKE_TIMEOUT(HttpResponseStatus.GATEWAY_TIMEOUT, 20008, "ID生成器调用超时")
    ;
