...
import com.oBrway.shortLink.common.util.PropertiesUtil;
...
public class ConfigLoader {
    private static final String CONFIG_FILE = "shortLink.properties";
    private static final String ENV_PREFIX = "SHORTLINK_";
    private static final String JVM_PREFIX = "shortLink.";
    ...
    public Config load(String[] args) {
        ...
        //环境变量 GATEWAY_PORT=8082
        loadFromEnv();

        //jvm参数 -Dgateway.port=8888
        loadFromJvm();
